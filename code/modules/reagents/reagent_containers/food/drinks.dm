...
/obj/item/weapon/reagent_containers/food/drinks/spaincup
	name = "Spanish cup"
	desc = "A cup with the Spanish flag emblazoned on it."
	icon_state = "spaincup"
	volume = 30

/obj/item/weapon/reagent_containers/food/drinks/dutchcup
	name = "Dutch cup"
	desc = "A cup with the Dutch flag emblazoned on it."
	icon_state = "dutchcup"
	volume = 30

/obj/item/weapon/reagent_containers/food/drinks/odincup
	name = "Odin IV cup"
	desc = "A cup with the Odin IV flag emblazoned on it."
	icon_state = "odincup"
	volume = 30

/obj/item/weapon/reagent_containers/food/drinks/germancup
	name = "German cup"
	desc = "A cup with the German flag emblazoned on it."
	icon_state = "germancup"
	volume = 30

/obj/item/weapon/reagent_containers/food/drinks/southacup
	name = "South African cup"
	desc = "A cup with the South Africa flag emblazoned on it."
	icon_state = "southacup"
	volume = 30

/obj/item/weapon/reagent_containers/food/drinks/ntcup
	name = "Nanotrasen cup"
	desc = "A really big cup with really big letters in the front: 'NT'"
	icon_state = "ntcup"
	volume = 60